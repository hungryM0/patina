...
|  |  |
| --- | --- |
| **今天**<br>![今天页面](assets/readme.zh-CN/dashboard.png)<br>今日活动、应用排行、分类分布、小时节奏和追踪状态。 | **历史**<br>![历史页面](assets/readme.zh-CN/history.png)<br>按日期回看时间线，查看合并活动片段和标题明细。 |
| **数据**<br>![数据页面](assets/readme.zh-CN/data.png)<br>查看 7 天、30 天、年度趋势、热力图和应用曲线。 | **应用**<br>![应用页面](assets/readme.zh-CN/mapping.png)<br>管理应用名称、分类、颜色、统计排除和标题记录。 |
| **设置**<br>![设置页面](assets/readme.zh-CN/settings.png)<br>调整追踪、驻留、外观、语言、备份、恢复和清理。 | **关于**<br>![关于页面](assets/readme.zh-CN/about.png)<br>查看版本、检查更新、下载新版本和查看发布说明。 |
